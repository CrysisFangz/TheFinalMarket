# -*- encoding: utf-8 -*-
# stub: ruby-statistics 4.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<rake>.freeze, ["~> 13.0", ">= 12.0.0"])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.13", ">= 3.10.0"])
  s.add_development_dependency(%q<byebug>.freeze, ["~> 11.1", ">= 11.1.0"])
  s.add_development_dependency(%q<pry>.freeze, ["~> 0.14", ">= 0.14.0"])
  s.add_development_dependency(%q<bigdecimal>.freeze, ["~> 3.1", ">= 3.1.9"])
end
